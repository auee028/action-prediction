                ...
                if motion_detect:
                    ...
                    if diff_thresh < args.frame_diff_thresh:#frame_num >= start_frame + args.action_video_length:
                        ...
                        if len(frames[start_frame:]) >= args.frame_thresh:
                            ...
                            print("\torig  : {}, {}, {}".format(result_o, confidence_o, top3_o))
                            tf.reset_default_graph()


                            # with tf.name_scope("predict_crop"):
                            result_c, confidence_c, top3_c = pred_action_crop(cropped_frames)
                            print("\tcrop : {}, {}, {}\n".format(result_c, confidence_c, top3_c))
                            # tf.reset_default_graph()
                            # cv2.waitKey(0)
