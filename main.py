...
parser.add_argument('--caption_length', type=int, default=64)
parser.add_argument('--action_length', type=int, default=16)
...
while cap.isOpened():
    ...
    if len(frames) >= 5:
        ...
        if (frame_num >= start_frame + args.video_length) and (result == None):
            motion_detect = False
