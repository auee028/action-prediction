                ...
                if self.move_detect:
                    if diff_thresh < .1:  # when the movement stops
                        ...
                        if len(out_frames) > 10:
                            return out_frames, self.move_detect
                        else:
                            return self.frames, False  # same as 'return [], False'

                    return out_frames, False  # same as 'return [], False'
...
class LSTMPredictor:
    def __init__(self):
        ...
        ckpt = os.path.join(self.model_path, ckpt_state.all_model_checkpoint_paths[10])
