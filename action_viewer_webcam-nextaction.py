...
from TFModel_nextaction import I3DClassifier, LSTMPredictor
...
def pred_action_orig(frames):
    ...
    if confidence > 0.8 and result != 'Doing other things':
...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture('/media/pjh/HDD2/Dataset/ces-demo-4th/original_video/0109/Juhee/14/2020-01-10-17-14-28_01_65.avi')     # reading
    ...
    # cap = cv2.VideoCapture('/media/pjh/HDD2/Dataset/ces-demo-4th/original_video/0109/Juhee/3/2020-01-09-17-26-34_01_69.avi')    # drinking
    ...
    while cap.isOpened():
                    ...
                    if diff_thresh < args.frame_diff_thresh:#frame_num >= start_frame + args.action_video_length:
                        ...
                        if len(frames[start_frame:]) >= args.frame_thresh:
                            ...
                            if calc_framediff(sampled_frames) < 34.25:     # Avg. diff of 100 samples : 34.2453916243 -> 34.25
                                ...
                                result, confidence, top_3 = pred_action_crop(cropped_frames)
        ...
        if not os.path.exists('/home/pjh/Videos/test-arbitrary_frames/{}'.format(len(action_list))):
            os.makedirs('/home/pjh/Videos/test-arbitrary_frames/{}'.format(len(action_list)))

        cv2.imwrite('/home/pjh/Videos/test-arbitrary_frames/{}/{}.jpg'.format(len(action_list), frame_num), display_frame)
    ...
    result = action_predictor.run_demo_wrapper(action_seq)
