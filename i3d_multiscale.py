...
def MultiscaleI3D(inputs,
	...
	with tf.variable_scope(scope, 'I3D', [inputs],reuse=reuse):
		...
		hiddens = [hidden_feat_1, hidden_feat_2, hidden_feat_3]
		if end_point == final_endpoint: return averaged_logits, end_points, hiddens

		if final_endpoint == 'SequatialLogits': return logits, end_points
