#-*- coding:utf-8 -*-
import sys
from importlib import reload  # python 3.x
reload(sys)
...
def pred_action(frames):
    ...
    if confidence > 0.5 and result != 'Doing other things':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--action_video_length', type=int, default=32)
        ...
        if len(frames) >= 5:
            ...
            if motion_detect:
                ...
                if motion_detect and (frame_num >= start_frame + args.action_video_length):
                    result, confidence, top_3 = pred_action(frames[-args.action_video_length:])
                                ...
                                if len(intent_list) >= 1 and len(action_list) != 0:
                                    ...
                                    if intent_list[-1] != result:
                                        ...
                                        try:
                                            ...
                                            requests.get(
                                                'http://192.168.0.4:3001/api/v1/actions/action/{}/{}'.format('home',
                                                                                                             intent_list[
                                                                                                                 -1]))
                                        ...
                                        print('action time:', start_frame, end_frame)
                                        action_list = []
